      ...
      >
        <div className="flex-1 flex flex-col items-center justify-center px-4">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 w-full max-w-sm text-center space-y-4">
            ...
            <h2 style={{ fontFamily: "'Jua', sans-serif", color: '#2F4780', fontSize: '22px' }}>Check your email!</h2>
            <p className="text-gray-500 text-sm leading-relaxed">
              We sent a confirmation link to <strong>{email}</strong>. Click it to activate your account, then log in.
            </p>
            <Link
              to="/login"
              className="block w-full text-white py-3 rounded-xl font-semibold text-sm text-center transition-opacity hover:opacity-90"
  ...
  return (
    ...
    <div className="flex-1 flex flex-col items-center justify-center px-4">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 w-full max-w-sm space-y-5">
        <h2 style={{ fontFamily: "'Jua', sans-serif", color: '#2F4780', fontSize: '24px' }}>Create Account</h2>
        ...
        <p className="text-center text-xs text-gray-400">
          ...
          <Link to="/login" className="font-semibold hover:underline" style={{ color: '#2F4780' }}>
            Log In
          </Link>
        </p>
      </div>
